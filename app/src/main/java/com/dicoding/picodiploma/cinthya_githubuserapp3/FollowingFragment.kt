...
import com.dicoding.picodiploma.cinthya_githubuserapp3.databinding.FragmentFollowingBinding
...
class FollowingFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        fragmentViewModel.getFollowing(username.toString())
        ...
        fragmentViewModel.listFollowing.observe(requireActivity(), { currentUser ->
            setReviewData(currentUser)
        })

        fragmentViewModel.isLoadingFollowing.observe(requireActivity(),{
            showLoading(it)
        })

        fragmentViewModel.snackbarFollowingError.observe(requireActivity(), {
